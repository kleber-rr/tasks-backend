pipeline {
    ...
    post {
        ...
        unsuccessful {
            emailext attachLog: true, body: 'See the attached log below', subject: 'Build $BUILD_NUMBER has failed', to: 'googleservices+jenkins@sefaz.rr.gov.br'
        }
        fixed {
            emailext attachLog: true, body: 'See the attached log below', subject: 'Build $BUILD_NUMBER is fine!!', to: 'googleservices+jenkins@sefaz.rr.gov.br'
        }
    }
}
